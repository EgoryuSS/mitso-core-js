...
return isInsideRectangleB(rect1.left, rect1.top) || isInsideRectangleB(rect1.left + rect1.width, rect1.top) 
|| isInsideRectangleB(rect1.left, rect1.top + rect1.height) || isInsideRectangleB(rect1.left + rect1.width, rect1.top + rect1.height)
|| isInsideRectangleA(rect2.left, rect2.top) || isInsideRectangleA(rect2.left + rect2.width, rect2.top) 
|| isInsideRectangleA(rect2.left, rect2.top + rect2.height) || isInsideRectangleA(rect2.left + rect2.width, rect2.top + rect2.height);
